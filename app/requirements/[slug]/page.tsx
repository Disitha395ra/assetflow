...
const departments = [
  "Admin Dept", "HR Dept", "IT Dept", "SOBM Dept", "Marketing Dept",
  "Finance Dept", "Student Admission Dept", "Registrar Dept", "EEE Dept",
  "ME Dept", "Civil Dept", "R & D Dept",
];
...
export default function PublicRequirementForm() {
  ...
  const [currentTime] = useState(Date.now);
  const [form, setForm] = useState({
    requesterName: "", requesterEmail: "", department: departments[0],
    item: "", quantity: "1", neededDate: "", reason: "",
  });
